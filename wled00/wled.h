...
// 2023 "Robototes 2412" Version
#define VERSION 202302412
...
WLED_GLOBAL byte col[]    _INIT_N(({ 190, 100, 50, 100 }));  // current RGB(W) primary color. col[] should be updated if you want to change the color.
